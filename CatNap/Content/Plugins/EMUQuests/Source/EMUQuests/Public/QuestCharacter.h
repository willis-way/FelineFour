...
UCLASS()
class QUESTSYSTEM_API AQuestCharacter : public ACharacter
{
	GENERATED_BODY()
	...
	/** MappingContext */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Input, meta = (AllowPrivateAccess = "true"))
	UInputMappingContext* QuestMappingContext;
...
public:
	...
	void SetOverlappedActor(AActor* Actor) { OverlappedActor = Actor; }
